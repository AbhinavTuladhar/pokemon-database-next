  ...
  return (
    <TableContainer>
      <thead>
        <th
          colSpan={2}
          className="table-cell border border-gray-200 bg-neutral-200 py-2 pr-4 text-xl font-bold dark:border-bd-dark dark:bg-hdr-dark"
        >
      ...
      <tbody>
        <tr className="table-row ">
          {gifSources.map((image, index) => (
            <td
              className="table-cell h-40 w-40 items-center border border-gray-200 object-center px-2 py-6 pr-4 dark:border-bd-dark"
              key={image + index}
            >
              <Image
                src={image}
