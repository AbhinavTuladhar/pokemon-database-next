  ...
  return (
    <section>
      ...
      <p>
        ...
        corresponding row to see how effective it is. The total number of Pokémon with each type are
        listed; click a number in that column to see a list of the actual Pokémon of that type
        combo.
      </p>
    </section>
  )
